...
export default function RespoDashboard() {
	...
	return (
		<div className="respo-dashboard-layout">
			{adminStats && (
				<>
					<span style={{ color: "var(--gray1-col)" }}> d'ensemble du système</span>
					...
					<div className="dashbord-mini-info-layout">
						<InfoWidget label="TER Actifs" icon={<TbSchool />} info={adminStats.active_ter_periods} color={TERStatusColor.get(TERStatus.OPEN) || "var(--blue-col)"} />
						<InfoWidget label="TER Brouillon" icon={<TbSchool />} info={adminStats.draft_ter_periods} color={TERStatusColor.get(TERStatus.DRAFT) || "var(--gray1-col)"} />
